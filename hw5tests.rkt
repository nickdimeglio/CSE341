...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (call (closure '() (fun "name" "x" (add (var "x") (int 7)))) (int 1))) (int 8) "call test1")

   ; apair test
   (check-equal? (eval-exp (apair (add (int 4) (int 11)) (int 35))) (apair (int 15) (int 35)) "apair test")

   ; fst test
   (check-equal? (eval-exp (fst (apair (int 4) (int 10)))) (int 4) "fst test")
   ...
   (check-equal? (eval-exp (ifeq (int 1) (var "ninety") (int 3) (int 4))) (int 4) "ifeq test2")
   (check-equal? (eval-exp (ifeq (int 1) (int 1) (int 3) (int 4))) (int 3) "ifeq test1")
   ;; mupl-map test
